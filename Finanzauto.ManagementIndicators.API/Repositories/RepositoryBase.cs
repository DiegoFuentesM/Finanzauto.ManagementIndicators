...
namespace Finanzauto.ManagementIndicators.API.Repositories
{
    public class RepositoryBase<T>: IAsyncRepository<T> where T : Entity
    {
        protected readonly GaviotaDataDbContext _context;

        public RepositoryBase(GaviotaDataDbContext context)
        {
            _context = context;
        }
